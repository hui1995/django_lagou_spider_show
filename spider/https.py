...
class Http:
    ...
    def get(self, url, headers=None, cookies=None, proxy=None, timeOut=10, timeOutRetry=10):
        '''
        获取网页源码
        url: 网页链接
        headers: headers
    ...
    def post(self, url, para, headers=None, cookies=None, proxy=None, timeOut=10, timeOutRetry=10):
        '''
        post获取响应
        url: 目标链接
        para: 参数
